...
Run the kabanero refresh command to refresh the list of collections from the curated collection, making these collections current with the activated collections across all namespaces in the Kabanero instance. This command can also be used to restore deactivated collections. See kabanero deactivate.
